          ...
          <tbody>
            {consolidado.map((c, i) => (
              <tr key={i} style={{ borderBottom: '1px solid #F3F4F6' }}>
                ...
                <td style={{ padding: '10px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, color: '#6B7280' }}>{c.factMesCxCorriente ? formatARS(parseArgMoney(c.factMesCxCorriente)) : '—'}</td>
                <td style={{ padding: '10px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, color: '#6B7280' }}>{c.factMesCxAnterior ? formatARS(parseArgMoney(c.factMesCxAnterior)) : '—'}</td>
                <td style={{ padding: '10px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, fontWeight: 600 }}>{formatARS(parseArgMoney(c.montoFacturadoTotal))}</td>
                <td style={{ padding: '10px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, color: '#6B7280' }}>{formatARS(parseArgMoney(c.costosCirugias))}</td>
                <td style={{ padding: '10px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, color: '#059669' }}>{formatARS(parseArgMoney(c.montoRecolectado))}</td>
                <td style={{ padding: '10px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, color: '#6B7280' }}>{formatARS(parseArgMoney(c.gastosProveedores))}</td>
                <td style={{ padding: '10px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, color: '#6B7280' }}>{formatARS(parseArgMoney(c.otrosGastos))}</td>
                <td style={{ padding: '10px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13 }}>{formatARS(parseArgMoney(c.totalGastos))}</td>
          ...
          {totals && (
            <tfoot>
              <tr style={{ background: '#F9FAFB', borderTop: '2px solid #E5E7EB', fontWeight: 700 }}>
                ...
                <td style={{ padding: '11px 14px', textAlign: 'right' }}>—</td>
                <td style={{ padding: '11px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13 }}>{formatARS(totals.montoFacturadoTotal)}</td>
                <td style={{ padding: '11px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, color: '#6B7280' }}>{formatARS(totals.costosCirugias)}</td>
                <td style={{ padding: '11px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, color: '#059669' }}>{formatARS(totals.montoRecolectado)}</td>
                <td style={{ padding: '11px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, color: '#6B7280' }}>{formatARS(totals.gastosProveedores)}</td>
                <td style={{ padding: '11px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, color: '#6B7280' }}>{formatARS(totals.otrosGastos)}</td>
                <td style={{ padding: '11px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13 }}>{formatARS(totals.totalGastos)}</td>
                <td style={{ padding: '11px 14px', textAlign: 'right' }}>—</td>
                <td style={{ padding: '11px 14px', textAlign: 'right' }}>—</td>
              </tr>
            </tfoot>
